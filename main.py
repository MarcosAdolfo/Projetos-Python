...
janela_init.geometry("500x500")
janela_init.config(bg="#DBEAFE")
...
tk.Label(janela_init,text=nome_jogo,font=("Arial", 30, "bold"), padx=50, pady=10, fg="#1E40AF",bg="#DBEAFE").pack()

tk.Label(janela_init,text="Modo de Jogo",font=("Arial", 20, "bold"), padx=50, pady=10, fg="#1F2937", bg="#DBEAFE").pack()

botao_tamanho_jogo = tk.OptionMenu(janela_init,tamanho_jogo, "4x4", "6x6", "8x8")
botao_tamanho_jogo.config(font=("Arial", 18, "bold"), padx=50, pady=10, fg="#FFFFFF", bg="#1E3A8A")
botao_tamanho_jogo.pack()

tk.Label(janela_init,text="Tema",font=("Arial", 20, "bold"), padx=50, pady=10, fg="#1F2937", bg="#DBEAFE").pack()

botao_tema = tk.OptionMenu(janela_init,cor_tema, *temas.keys())
botao_tema.config(font=("Arial", 18, "bold"), padx=50, pady=10, fg="#FFFFFF", bg="#1E3A8A")
botao_tema.pack()

botao_init = tk.Button(janela_init, text="Iniciar Jogo", command=iniciar)
botao_init.config(font=("Arial", 18, "bold"), padx=100, pady=10, fg="#FFFFFF", bg="#1E3A8A")
botao_init.pack()
